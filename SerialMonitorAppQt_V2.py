            ...
            if chunk:
                ...
                for line_bytes in lines[:-1]:
                    ...
                    if is_header_line(parts):
                        ...
                        for p in parts:
                            lp = p.lower()
                            if "v_in" in lp or "vin" in lp:
                                normalized_headers.append("V_IN")
                            elif "v_out" in lp or "vout" in lp:
                                normalized_headers.append("V_OUT")
                            elif "adc_in" in lp or "adcin" in lp:
                                normalized_headers.append("ADC_IN")
                            elif "adc_out" in lp or "adcout" in lp:
                                ...
                                normalized_headers.append(p.strip())
